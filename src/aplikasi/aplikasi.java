...
import java.util.Calendar;//untuk mengeset tangal dn mendapatkan tanggal
//try catch
import java.text.ParseException; //menangkap kesalahan dalam teks
import java.io.IOException; //menghendel kesalahan pada input putput
import java.io.*;//untuk menampilkan objek pada library unput output
...
public class aplikasi {
    ...
    static int denda, telat_hari, kembalian_denda, bayar_denda;
    static char telat;
    //input tanggal tanggal pada bentuk string
    static String oldDate = "";
    static Scanner input = new Scanner(System.in); //untuk input data integer(bilangan)
    static Scanner str = new Scanner(System.in);   //untuk input data string
    static Scanner strline = new Scanner(System.in); //untuk string yang mengandung spasi

    public static void main(String[] args) throws Exception {
        int pilih, trans, count = 0, uang; // Count digunakan untuk peletakan index array.
        int[] k = new int[10];
        String daftar, nama;
        char opsi1;
    ...
    public static void SaveLaporan(String nama, int uang) {
        try {
            File file = new File(nama + ".txt");//nama file yang akan disimpan
    ...
    public static void HapusLaporan(String nama) {
        ...
        if (file.delete()) {
            System.out.println("struk terhapus");
        }
